/*
Write a C Program to print out the memory locations of BSS, Stack, Variable on the Stack, Heap and etc.
*/
#include <sys/shm.h>
#include <errno.h>
#include <string.h>
...
void func(int i)
{
        int fint;                                                                                                                                                                                                          static int n = 1;    //Putting n=0 also in one of the screenshots of output                                                                                                                                                                                                  char *msg = "from func";
        if (i)
        {
                msg = "recursive";
        }
...
int main(int argc, char **argv, char **envp)
{
        ...
        printf("func_array[] (like 'array[]', but on stack) from %lX to %lX\n", (unsigned long)&func_array[0], (unsigned long)&func_array[ARRAY_SIZE]);
