/*
 ...
 Program: Write a shell script with three array structures to hold the values as given
 below,
 Arrray_empl = (Naman Karthik Vishal………)
 Array_basic = ( 9000 15000 18000………)
 Array_gross = (0 0 0……..)
 Update the corresponding (based on the array index) gross salary of the
 employees in the Array_gross according to rule given below,
 If basic salary is &amp;lt; Rs15000 then Gross Salary = basic Salary + 90% of
 basic salary.

 If basic salary is &amp;gt;=Rs15000 then Gross Salary = basic Salary + 98% of
 basic salary.
