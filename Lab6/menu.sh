...
do
        ...
        case $ch in
                ...
                4)
                        ...
                        read file
                        touch $file
                        echo "Select role:"                                                                                                                                                     echo "a.Administrator"                                                                                                                                                  echo "b.Student"
                        echo "c.Faculty"
                        read role
                        case $role in
                           "a")
                ...
                5)
                        ...
                        echo "Creating the files entered!"
                        echo "Enter the file extension based on which you want to group files:"
                        read ext
                        find . -name "*.$ext"
                        zip group.zip *.$ext
                        unzip -l group.zip
                ...
                6)
                        ...
                        touch -d 20150505 file1.txt
                        touch -d 20170622 file2.txt
                        touch -d 20200101 file3.txt
                        touch -d 20200522 file4.txt
                        find . -mtime +90 | xargs zip oldfiles.zip
                        unzip -l oldfiles.zip
                        ;;
                7)
                ...
                8)
                        ...
                        find -size +1G | xargs zip largefiles.zip
                        unzip -l largefiles.zip
                        ;;
                9)
                        echo "Enter the permission to find:"
                        ...
                        case $type in
                        "a")
                                find -perm 444 | xargs zip readonly.zip
                                unzip -l readonly.zip
                                ;;
                        "b")
                                find -perm 666 | xargs zip readwrite.zip
                                unzip -l readwrite.zip
                                ;;
                        "c")
                                find -perm 777 | xargs zip allper.zip
                                unzip -l allper.zip
                                ;;
                        "*")
                                echo "Invalid input!!"
