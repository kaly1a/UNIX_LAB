/*
Demonstrate two-way data transfer with synchronization between Threads using Shared Memory and Mutex/Semaphore.
*/
#include <stdio.h>
#include <pthread.h>
#include <semaphore.h>
...
void* thread(void* arg) { //function which act like thread
   ...
   printf("\nHey! You entered into the Critical Section..\n");
